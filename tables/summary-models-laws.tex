\begin{table}
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{threeparttable}
      \begin{tabular}{m{11.5em} C{4em} @{\hskip 1.5em} C{4em} @{\hskip 1.5em} C{4em} @{\hskip 1.5em} C{4em} @{\hskip 1.5em} C{4em} @{\hskip 1.5em} C{4em}}
        ...
        \addlinespace[.25em]
        \vspace{.75em} Meaning distribution law \vspace{.75em} & No \cellcolor{TableLightRed} & No \cellcolor{TableLightRed} & Yes \tnote{1} \cellcolor{TableLightYellow} & Yes \tnote{1} \tnote{2} \cellcolor{TableLightYellow} & No \cellcolor{TableLightRed} & Yes \tnote{1} \cellcolor{TableLightYellow} \\
        \addlinespace[.25em]
      ...
      \begin{tablenotes}
        ...
        \item [2] See \cite{Ferrer2016b} for mathematical reasoning.
  ...
  \caption{
    ...
    The vocabulary learning bias for the \secondmodel{} remains unstudied.
  }
