...
\begin{abstract}
  ...
  They have also been used to make predictions, such as the biases present in child word learning.
  ...
  The models go through an optimization process.
  After this process the linguistic laws they can predict are examined, as well as to which degree they can be predicted.
  ...
  The effects of several initial conditions in the optimization process is also studied.
