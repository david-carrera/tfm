...
\begin{table}
  ...
  \begin{adjustbox}{max width=\textwidth}
    \begin{tabular}{m{11.5em} C{4em} @{\hskip 1.5em} C{4em} @{\hskip 1.5em} C{4em} @{\hskip 1.5em} C{4em} @{\hskip 1.5em} C{4em} @{\hskip 1.5em} C{4em}}
      ...
      \addlinespace[.25em]
      \vspace{.75em} Meaning distribution law \vspace{.75em} & No \cellcolor{TableLightRed} & No \cellcolor{TableLightRed} & Yes \cellcolor{TableLightGreen} & No \cellcolor{TableLightRed} & No \cellcolor{TableLightRed} & Yes \cellcolor{TableLightGreen} \\
      \addlinespace[.25em]
      ...
      \addlinespace[.25em]
      \vspace{.75em} Vocabulary learning bias \vspace{.75em} & No \cellcolor{TableLightRed} & No \cellcolor{TableLightRed} & Yes \cite{Ferrer2017a} \cellcolor{TableLightGreen} & Unknown \cellcolor{TableLightBlue} & Yes \cite{Carrera2021a} \cellcolor{TableLightGreen} & Unknown \cellcolor{TableLightBlue} \\
      \bottomrule
    \end{tabular}
  \end{adjustbox}
  \caption{
