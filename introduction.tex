...
\redtxt{Linguistic laws have been previously recovered in the transition between a referentially useless system and an indexical reference system. \cite{Ferrer2003a}
  ...
  \end{equation}
  We hypothezise that referentially useless words are common during the referentially useless phase ($\lambda < 0.5$) and disappear for greater values of $\lambda$.
}
