...
\begin{redenv}
  ...
  \item Single link: The initial graph contains a single link between a word and a meaning. \redtxt{This initial condition is also a minimum of the cost function for $\lambda \leq 1/2$ (See Section \ref{sec:model_math_min-max-cost-fun})}
  \item One-to-one: The initial graph is a bijection connecting words and meanings one to one,
    \redtxt{which is a minimum of the cost function when $\lambda \geq \frac{1}{2}$ (Section \ref{sec:model_math_min-max-cost-fun})}
...
\begin{figure}
  \centering
  \includegraphics[height=0.9\textheight,width=\textwidth,keepaspectratio]{graphVisualization_firstModel_phi1_nm60_static_randomBipartite_allowUnlinked}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[height=0.9\textheight,width=\textwidth,keepaspectratio]{graphVisualization_firstModel_phi1_nm60_static_singleLink_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.9\textheight,width=\textwidth,keepaspectratio]{graphVisualization_firstModel_phi1_nm60_static_oneToOne_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.9\textheight,width=\textwidth,keepaspectratio]{graphVisualization_firstModel_phi1_nm60_static_complete_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.9\textheight,width=\textwidth,keepaspectratio]{graphVisualization_uniform_phi1_nm60_static_randomBipartite_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.9\textheight,width=\textwidth,keepaspectratio]{graphVisualization_uniform_phi1_nm60_static_singleLink_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.9\textheight,width=\textwidth,keepaspectratio]{graphVisualization_uniform_phi1_nm60_static_oneToOne_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.9\textheight,width=\textwidth,keepaspectratio]{graphVisualization_uniform_phi1_nm60_static_complete_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{insideLambda_firstModel_phi0_nm400_dynamic_randomBipartite_allowUnlinked}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{insideLambda_firstModel_phi0_nm400_dynamic_oneToOne_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.65\textheight,width=\textwidth,keepaspectratio]{fitting_insideLambda_firstModel_phi0_nm400_dynamic_randomBipartite_allowUnlinked}
  \caption{
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_firstModel_phi1_nm400_dynamic_randomBipartite_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_firstModel_phi1_nm400_dynamic_singleLink_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_firstModel_phi1_nm400_dynamic_oneToOne_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{insideLambda_firstModel_phi1_nm400_dynamic_randomBipartite_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{insideLambda_firstModel_phi1_nm400_dynamic_oneToOne_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_uniform_phi0_nm400_dynamic_randomBipartite_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_uniform_phi0_nm400_dynamic_singleLink_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_uniform_phi0_nm400_dynamic_oneToOne_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{insideLambda_uniform_phi0_nm400_dynamic_randomBipartite_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{insideLambda_uniform_phi0_nm400_dynamic_oneToOne_allowUnlinked.pdf}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_uniform_phi1_nm400_dynamic_randomBipartite_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_uniform_phi1_nm400_dynamic_singleLink_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{informationTheoretic_uniform_phi1_nm400_dynamic_oneToOne_allowUnlinked}
  \caption{Same information as in Figure \ref{fig:informationTheoretic_firstModel_phi0_nm400_dynamic_randomBipartite_allowUnlinked} but the graph uses the equations of the \secondmodel{} with $\pi$ following a uniform distribution with $\pi=1$.
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{insideLambda_uniform_phi1_nm400_dynamic_randomBipartite_allowUnlinked}
...
\begin{figure}
  \centering
  \includegraphics[height=0.7\textheight,width=\textwidth,keepaspectratio]{insideLambda_uniform_phi1_nm400_dynamic_oneToOne_allowUnlinked}
